...
@Controller("queryByOutletsExportAction")
@Scope("prototype")
@Namespace("/business/statistics/querybyoutlets/export")
@ParentPackage("json-default")
public class QueryByOutletsExportAction implements ServletResponseAware, SessionAware
{
	private static final Logger logger = LogManager.getLogger(QueryByOutletsExportAction.class);
	...
	public String exportExcel()
	{
		try
		{
			HSSFWorkbook wb = statisticsExportService.getExportDataByOutlets();
			if ( wb == null )
			{
				result = false;
				errorMsg = "按网点导出报表错误";
