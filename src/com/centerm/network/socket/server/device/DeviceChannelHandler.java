...
@Component("deviceChannelHandler")
@Scope("prototype")
public class DeviceChannelHandler extends ChannelDuplexHandler
{
	private static final Logger logger = LogManager.getLogger(DeviceChannelHandler.class);
	
	private boolean readOver = false;	//是否读取完毕
	private byte[] msgBody;	//报文体
	
	@Resource(name = "deviceAnalyzer")
