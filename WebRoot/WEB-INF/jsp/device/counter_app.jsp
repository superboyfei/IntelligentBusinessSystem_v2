...
<html>
  <head>
    ...
    <link href="res/css/tellerApps-update.css" rel="stylesheet">
  </head>
  
  <body>
      <!--appUpdateModal-->
      <div class="modal fade" id="tellerAppsModal"  role="dialog" aria-hidden="true" data-backdrop="static">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">应用上传</h4>
              </div>
              <div class="modal-body">
                  <form class="form-horizontal">
                      <div class="form-group">
                          <label class="col-sm-3 control-label">选择上传的应用:</label>
                          <div class="col-sm-9">
          ...
          <div class="modal-dialog">
              <div class="modal-content">
                  <div class="modal-header">
                      ...
                      <h4 class="modal-title">应用更新说明</h4>
                  </div>
                  <div class="modal-body">
      ...
      <div class="center-tool-bar">
          <button class="btn btn-primary btn-sm" data-toggle='modal'  data-target='#tellerAppsModal' id="uploadBtn">
              <span class="glyphicon glyphicon-cloud-upload" aria-hidden="true" ></span> 上传应用
          </button>
      </div>    
      <!--展示柜台应用信息-->
      <div class="tellerApps-holder" id="tellerApps-holder">
      ...
      <script type="text/javascript" src="script/device/counter-app.js"></script>
