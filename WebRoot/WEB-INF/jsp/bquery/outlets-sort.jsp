...
<script type="text/javascript" src="script/bquery/buss-outletsQuery.js"></script>      
...
$(document).ready(function() {
	$('#exportBtn').click(function() {
		...
		$.post("business/statistics/querybyoutlets/export/loadExportData.action", param, function(result){
			location.href = "<%=basePath%>" + "business/statistics/querybyoutlets/export/exportExcel.action";
		});
	});
});
</script>  
