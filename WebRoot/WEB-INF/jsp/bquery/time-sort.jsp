...
<html>
	...
	<body>
        <div class="ui-layout-center">
            ...
            <label id="haha"></label>
              <label class="btn btn-default disabled" id="tableBtnByTime">
                <input type="radio" name="options" autocomplete="off" checked> 表格列表
              </label>
              <label class="btn btn-default disabled" id="barBtnByTime">
                <input type="radio" name="options" autocomplete="off"> 条形图
              </label>
              <label class="btn btn-default disabled" id="pieBtnByTime" >
                <input type="radio" name="options"autocomplete="off"> 饼状图
              </label>
            </div>
            </div>
            <div class="table-contain" id="table-contain" style="display:block">       
             <table id="timeSort-jqGrid"></table>
             <div id="jqGridPager"></div>
            </div>
            <div class="table-contain" id="table-contains" style="display:none;overflow:auto;width:890px;height:530px;">
            </div>
            <div class="table-contain" id="table-contains2" style="display:none;overflow:auto;width:890px;height:530px;">
        ...
        <div class="ui-layout-west">
            ...
            <h5 class="west-sort-title expand">请选择时间条件<span></span></h5>
            <div class="west-sort-div">
                <div class="form-group">
                    <select class="form-control "id="selectTime">
                        <option value="0">按日期检索</option>
                        <option value="1">按月份检索</option>
                        <option value="2">按年份检索</option>
                        <option value="3">按季度检索</option>
                    </select>
                </div>
                <div class="date-picker-quarter" style="display:none">
                    <h6>请选择开始年份和季度</h6>
	    			<div class="form-group">                     
	                    <div id="year-of-start" class="input-group date form_date col-md-12">
	                        <input id="startQuarterYear" class="form-control" size="16" type="text" readonly>                        
                    ...
                    <h6>请选择结束年份和季度</h6>
	    			<div class="form-group">                     
	                    <div id="year-of-end" class="input-group date form_date col-md-12">
	                        <input id="endQuarterYear" class="form-control" size="16" type="text" readonly>                        
	    					<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
	                    </div>
                ...
                <div class="date-picker-normal">
	                <h6 id="startdate-select">请选择开始日期</h6>
	    			<div class="form-group">                     
	                    <div id="start-date" class="input-group date form_date col-md-12" data-date="" data-date-format="yyyy MM dd" >
	                        <input id="dateStart" class="form-control" size="16" type="text" readonly>                        
	    					<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
	                    </div>
	                 </div>
	                <h6 id="enddate-select">请选择结束日期</h6>
	                <div class="form-group">                     
	                    <div id="end-date" class="input-group date form_date col-md-12" data-date="" data-date-format="yyyy MM dd" >
	                        <input id="dateEnd" class="form-control" size="16" type="text" readonly>                        
	                        <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
	                    </div>
	                 </div> 
                 </div>
            ...
            <h5 class="west-sort-title">请选择业务类型<span></span></h5>
            <div class="west-sort-div" style="display:none">
...
<script type="text/javascript" src="script/bquery/buss-timeQuery.js"></script>     
...
$(document).ready(function() {
	$('#exportBtn').click(function() {
		...
		$.post("business/statistics/querybytime/export/loadExportData.action", param, function(result){
			location.href = "<%=basePath%>" + "business/statistics/querybytime/export/exportExcel.action";
		});
	});
});
